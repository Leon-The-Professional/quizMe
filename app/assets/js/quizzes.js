...
let ArraysQuiz = {
    ...
    questions: [
        ...
        `3.	What does the APM .push() do? Is it destructive?`,
        `4.	What does the APM .pop() do? Is it destructive?`,
        `5.	What does the APM .shift() do? Is it destructive?`,
        `6.	What does the APM .unshift() do? Is it destructive?`,
        ...
        `8.	How can rest (syntax …) be used when destructuring an array? Provide an example.`,
        `9.	What does the APM .concat() do? Is it destructive?`,
        `10. What does the APM .join() do? Is it destructive?`,
        `11. What does the APM .includes() do? Is it destructive?`,
        `12. What does the APM .reverse() do? Is it destructive?`,
        `13. What does the APM .indexOf() do? Is it destructive?`,
        `14. What does the APM .slice() do? Is it destructive?`,
        `15. What does the APM .splice() do? Is it destructive?`,
        ...
        `19. What does the APM .map() do? Is it destructive?`,
        `20. What does the APM .filter() do? Is it destructive?`,
        `21. What does the APM .some() do? Is it destructive?`,
        `22. What does the APM .every() do? Is it destructive?`,
        `23. What does the APM .sort() do? Is it destructive?`,
        `24. What does the APM .reduce() do? Is it destructive?`,
    ],
    answers: [
